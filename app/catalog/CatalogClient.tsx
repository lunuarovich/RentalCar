...
import CatalogFilters, { type FilterValues } from '@/components/CatalogFilters/CatalogFilters';
...
const LIMIT = 12;
const EMPTY_FILTERS: FilterValues = { brand: '', rentalPrice: '', minMileage: '', maxMileage: '' };
  ...
  return (
    <main className={css.section}>
      <Container>
        ...
        {isLoading && <div className={css.center}><Loader /></div>}
        {isError && <p className={css.message}>Something went wrong. Please try again later.</p>}
        {!isLoading && !isError && cars.length === 0 && <p className={css.message}>No cars found for selected filters.</p>}
